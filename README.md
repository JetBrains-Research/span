...
| `--bg-sensitivity SENSITIVITY`                          | Configures background sensitivity for peaks.<br>Recommended value for generic ChIP-seq: `0.1`<br>Recommended value for TFs and ATAC-seq: `1.0`                                                                                                                       |
