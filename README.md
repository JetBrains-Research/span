...
| `--clip`                                                | Clip peaks to improve peaks density using local signal coverage.<br>Recommended for TFs, narrow histone marks and ATAC-seq.                                                                                                                                          |
...
| `--threads THREADS`                                     | Configure the parallelism level. <br>SPAN utilizes both multithreading and specialized processor extensions like SSE2, AVX, etc.                                                                                                                                     |
