...
| `--bg-sensitivity SENSITIVITY`                          | Configures background sensitivity for peaks.<br>Recommended value for generic ChIP-seq: `0.2`<br>Recommended value for TFs and ATAC-seq: `1.0`                                                                                                                  |
| `--clip CLIP`                                           | Clip peaks to improve peaks density using local signal coverage. Default: `0.4`                                                                                                                                                                                 |
