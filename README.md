...
| `--sensitivity SENSITIVITY`                             | Configures background sensitivity for peaks.<br>Automatically estimated from the data, or during semi-supervised peak calling.                                                                                                                            |
| `--gap GAP`                                             | Configures minimal gap between peaks.<br>Automatically estimated from the data, or during semi-supervised peak calling.                                                                                                                                    |
