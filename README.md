...
| `--hmm-snr SNR`                                         | Fraction of coverage to estimate and guard signal to noise ratio, `0` to disable.                                                                                                                                                                                    |
...
| `--fragmentation FRAGMENTATION_THRESHOLD`               | Maximal fragmentation threshold to apply compensational gap.<br>Not available when `gap` is explicitly provided.                                                                                                                                                     |                  
...
| `--clip`                                                | Clip max threshold for fine-tune boundaries according to local signal, `0` to disable.                                                                                                                                                                               |
