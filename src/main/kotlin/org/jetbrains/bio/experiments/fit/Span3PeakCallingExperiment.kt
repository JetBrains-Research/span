...
class Span3PeakCallingExperiment private constructor(
        fitInformation: Span3FitInformation,
        fixedModelPath: Path?
) : SpanModelFitExperiment<NegBinRegressionMixture, Span3FitInformation, ZLH>(
        fitInformation,
    ...
    companion object {
        ...
        fun getExperiment(
            ...
            val fitInformation = Span3FitInformation(
...
data class Span3FitInformation constructor(
