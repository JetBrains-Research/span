...
class SpanPeakCallingExperimentNB5ZHMM<Model : ClassificationModel> private constructor(
    ...
    fitInformation, modelFitter, modelClass, Z5.values(),
    NullHypothesis.of(Z5.Z, Z5.S1, Z5.S2, Z5.S3, Z5.S4),
    fixedModelPath,
    ...
    companion object {
        ...
        fun fitter() = object : Fitter<NB5ZHMM> {
            ...
            override fun guess(
                ...
                val (means, failures) = guess(preprocessed, 5)
                return NB5ZHMM(means, failures)
            }
        }
    }
